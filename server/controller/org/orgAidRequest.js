...
const createOrgJob = async (req, res) => {
    const { orgId, orgName,requestTitle, population, dueDate, orgOtherDetails, orgLocation, orgTelephone } = req.body
//    console.log(req.body);
    //add doc to db
    try {
        const newOrgAidRequest = await OrgAidRequest.create({ orgId, orgName,requestTitle, population, dueDate, orgOtherDetails, orgLocation, orgTelephone })
